...
<br />
<div align="center">
  <a href="https://github.com/leewenghin/filmpire.git">
  ...
  <p align="center">
    An awesome Netflix Clone to try!
    <br />
    ...
    ·
    <a href="https://github.com/leewenghin/filmpire/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
2. Clone the repo
   ```sh
   git clone https://github.com/leewenghin/filmpire.git
   ```
3. Install NPM packages
   ```sh
   npm install
   ```
4. Enter your TMDB API KEY in `.env`
   ```js
   REACT_APP_TMDB_KEY = "<ENTER YOUR KEY HERE>";
   ```
...
_For more examples, please refer to the [Documentation](https://developer.themoviedb.org/docs/getting-started)_
